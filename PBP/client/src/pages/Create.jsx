...
export default function Create()
{
    ...
    return(
        <div className="w-full">
            ...
            <h1 className="text-3xl font-bold mb-8 text-center">Create a post</h1>
               <form className="w-full" onSubmit={handleSubmit}>
                <div className="flex flex-col w-full gap-y-7">
                    ...
                    <button className="bg-blue-500 text-white py-2 px-5 rounded-md text-lg font-bold tracking-wide">Publish</button>
                </div>
               </form>
            </div>
        </div>
